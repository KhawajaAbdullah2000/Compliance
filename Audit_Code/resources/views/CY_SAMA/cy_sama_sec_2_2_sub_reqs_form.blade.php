    ...
    Req No. {{$filteredData[0][4]}}
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6">
                ...
                <form action="/cy_sama_sec_2_2_edit_form/{{$sub_req}}/{{$title}}/{{$project_id}}/{{auth()->user()->id}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
             ...
             <option value="partial" {{ old('comp_status',$result->comp_status) == 'partial' ? 'selected' : '' }}>Partial</option>
                 ...
                 <input type="file" name="attachment">
                      ...
                      <a href="{{asset('cy_sama_sec_2_2/'.$result->attachment)}}" download>
                        {{$result->attachment}}
                      </a>
...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <form action="/cy_sama_sec_2_2_form/{{$sub_req}}/{{$title}}/{{$project_id}}/{{auth()->user()->id}}" method="post" enctype="multipart/form-data">
            @csrf
