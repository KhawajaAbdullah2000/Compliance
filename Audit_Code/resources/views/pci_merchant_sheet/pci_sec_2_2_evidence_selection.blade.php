...
<div class="container">
    ...
    <div class="row h-100 w-75">
        <div class="row mt-2" >
         ...
         <a href="/pci_merchant_sheet_subsections/{{$project_id}}/{{auth()->user()->id}}/{{$asset->assessment_id}}" class="btn btn-lg btn-warning w-100"><p class="fw-bold" style="text-align: left;">Upload or enter evidence against the mandatory requirements of PCI-DSS v4-Merchant</p></a>
        </div>
        </div>
