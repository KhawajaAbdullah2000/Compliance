    ...
    <table class="table table-bordered table-responsive table-primary">
        ...
        <tbody>
            <tr>
                ...
                <td><a href="/pci_merchant_sec_2_2_req/{{($data[0][1]) }}/{{$title}}/{{$project_id}}/{{auth()->user()->id}}" class="btn btn-sm my_bg_color text-white">View</a></td>
            ...
            <tr style="vertical-align: middle;text-align:initial">
                    ...
                    <td>
                       ...
                       <td><a href="/pci_merchant_sec_2_2_req/{{$my_current_main_req_num}}/{{$title}}/{{$project_id}}/{{auth()->user()->id}}" class="btn btn-sm my_bg_color text-white">View</a></td>
                    @endif
