          ...
          <div class="card-body">
            ...
            <form class="row g-3" method="POST" action="/edit_org/{{$org->name}}/{{$org->sub_org}}">
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="name" id="name" value="{{old('name',$org->name)}}">
              </div>
              @if($errors->has('name'))
          ...
          @endif
              ...
              <div class="col-md-6">
                  ...
                  <select class="boxstyling bg-primary form-select" name="type">
                      ...
                      <option value="guest" {{ old('type',$org->type) == 'guest' ? 'selected' : '' }}>Guest</option>
                      <option value="host" {{ old('type',$org->type) == 'host' ? 'selected' : '' }}>Host</option>
                  </select>
              </div>
           @if($errors->has('type'))
      ...
      @endif
          ...
          <div class="col-md-6">
              ...
              <select class="boxstyling bg-primary form-select" name="status">
                  <option value="active" {{ old('status',$org->status) == 'active' ? 'selected' : '' }}>Active</option>
                  <option value="inactive" {{ old('status',$org->status) == 'inactive' ? 'selected' : '' }}>Inactive</option>
              </select>
