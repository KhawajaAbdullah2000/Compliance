...
<div class="container">
    ...
    <a href="/sbp_etgrmf_subsections/{{$project_id}}/{{auth()->user()->id}}/{{$asset->assessment_id}}" class="btn btn-primary btn-md float-end">Go to All Requirements</a>
    ...
    <table class="table table-bordered table-responsive table-primary">
        ...
        <tbody>
            ...
            <tr>
                ...
                <a href="/sbp_etgrmf_sec2_2_sub_req_edit/{{$d[4]}}/{{$title}}/{{$project_id}}/{{auth()->user()->id}}/{{$asset->assessment_id}}">
