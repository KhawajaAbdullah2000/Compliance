        ...
        <div class="card-body p-4">
            ...
            <form class="row g-4" method="POST" action="/add_new_asset_type/{{auth()->user()->organization->id}}/{{$categoryDetails->asset_category_id}}">
                ...
                <div class="col-md-12 mb-4">
                    <div class="form-floating">
                        <input type="text" class="form-control" 
                               name="asset_type" placeholder="Enter Asset SubType" value="{{old('asset_type')}}" required>
                ...
                <div class="col-12 text-center mt-4">
                    <button type="submit" class="btn btn-primary btn-lg px-5 py-2 fw-semibold">Add Asset SubType</button>
                </div>
            </form>
        </div>
    </div>
