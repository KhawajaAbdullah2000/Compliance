                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid black;">
                        ...
                        <td style='text-align:center'>
                            ...
                            <a href="/internal_audit_level_1/1/{{$pro->project_code}}/{{auth()->user()->id}}" data-toggle="tooltip" title="Internal Audit">
                                <i class="fas fa-edit fa-lg text-success"></i>
                            </a>

                            @else
                            <a href="/iso_sections/{{ $pro->project_code }}/{{ auth()->user()->id }}" data-toggle="tooltip" title="Edit Project Data">
                                <i class="fas fa-edit fa-lg text-success"></i>
                            </a>
                            @endif
                        </td>
                        ...
                        {{-- Risk Heatmap --}}
                        <td style='text-align:center'>
                            <a href="/heatmap_select_services_and_risks/{{$pro->project_code}}/{{auth()->user()->id}}" data-toggle="tooltip" title="View Risk Heatmap">
                        ...
                        {{-- Action Plan --}}
                        <td style='text-align:center'>
                            <a href="/action_plan/{{ $pro->project_code }}/{{ auth()->user()->id }}" data-toggle="tooltip" title="Action Plan">
                        ...
                        <td style='text-align:center'>
                            <i class="fas fa-copy fa-lg text-danger" data-toggle="modal" data-target="#duplicateProjectModal" data-project-code="{{ $pro->project_code }}" title="Duplicate Project">
                            </i>
                        </td>
