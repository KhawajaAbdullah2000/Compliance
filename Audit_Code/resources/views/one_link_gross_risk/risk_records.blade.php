            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover text-center align-middle">
                        ...
                        class="text-info view-risk-output"
                        ...
                        data-blank3="{{ $record->blank3 }}">
                            <i class="fas fa-eye fa-2x" style="cursor: pointer;"></i>
                                    ...
                                    <td>
                                       <a href="/initiate_gross_assessment_form/{{$record->risk_id}}/{{$project->project_id}}/{{auth()->user()->id}}" class="text-primary me-2">
...
<div class="modal gross_risk_modal fade" id="grossRiskModal" tabindex="-1" aria-labelledby="grossRiskModalLabel" aria-hidden="true">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('.view-risk-output').forEach(function (icon) {
            icon.addEventListener('click', function () {
                ...
                document.getElementById('modal-overall-impact').textContent = `${overallImpact} (${blank1})`;
                document.getElementById('modal-likelihood').textContent = likelihood;
                document.getElementById('modal-inherent-rating').textContent = `${inherent} (${blank3})`;
