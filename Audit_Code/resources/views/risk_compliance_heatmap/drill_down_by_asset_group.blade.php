        ...
        <tbody>
            @foreach ($complianceData as $data)
                ...
                <tr>
                    ...
                    <td>
                        <a href="/risk_compliance_heatmap/{{ $project->project_id }}/{{$data['group_name']}}/{{ auth()->user()->id }}" 
                           data-toggle="tooltip" title="Risk and Compliance Heatmap for {{$data['group_name']}}">
