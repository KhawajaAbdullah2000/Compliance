...
<div class="container my-2">
            ...
            <table class="table table-bordered table-secondary">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $s_name }}</td>
                        <td class="fw-bold">No. of Asset</td>
                        <td>{{ $distinctAssetCount }}</td>
                    </tr>

                    <tr>
                        <td class="fw-bold">No. of Group</td>
                        <td>{{ $distinctGroupCount }}</td>
                        <td class="fw-bold">Asset Component:</td>
                        <td>{{ $c_name }}</td>
                    </tr>
                </tbody>
            </table>
    ...
    <h3 class="text-center fw-bold">Risk and Compliance Heatmap for Service: {{$s_name}} and Component: {{$c_name}}</h3>
