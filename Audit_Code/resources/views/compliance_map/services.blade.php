...
<div class="container my-2">
    ...
    <h3 class="fw-bold text-center mt-4 mb-4">View or Download Compliance Map (Selected Domain-Selected Service-All Applicable Controls)</h3>
                    ...
                    <ul class="list-group">
                        @foreach($services as $service)
                            <li class="list-group-item">
                                <a href="{{ route('service.groups', ['domain'=>$domain,'service' => $service->s_name,'proj_id'=>$project->project_id]) }}" class="btn btn-primary">
                                    {{ $service->s_name }}
                                </a>
                            </li>
                        @endforeach
