  ...
  <div class="row g-4 align-items-start">
    ...
    <div class="col-lg-4 col-md-4">
      ...
      <div class="card qa-card overflow-hidden h-100">
        <div class="card-body p-4">
          <h5 class="mb-1">Global Actions</h5>
    ...
    <div class="col-lg-4 col-md-4">
      ...
      <div class="card qa-card overflow-hidden h-100">
           ...
           <div class="card-body p-4">
          <h5 class="mb-1">Specific Actions</h5>
          ...
          <div class="d-grid gap-3">
           ...
           <a href="/create_project/{{ auth()->user()->id }}" class="btn btn-tile btn-create-project">
              ...
              <i class="bi bi-arrow-right"></i>
               ...
               <a href="/create_project/{{ auth()->user()->id }}/compliance" class="btn btn-tile btn-scanner">
              <span class="label"><i class="bi bi-clipboard-plus"></i> Create Compliance Assessment</span>
              <i class="bi bi-arrow-right"></i>
            </a>

            
               <a href="/create_project/{{ auth()->user()->id }}/risk_assessment" class="btn btn-tile btn-risk-register">
              <span class="label"><i class="bi bi-clipboard-plus"></i> Create Risk Assessment</span>
              <i class="bi bi-arrow-right"></i>
            </a>

                   
               <a href="/create_project/{{ auth()->user()->id }}/implementation" class="btn btn-tile btn-services">
              <span class="label"><i class="bi bi-clipboard-plus"></i> Create Implementation</span>
              <i class="bi bi-arrow-right"></i>
            </a>
