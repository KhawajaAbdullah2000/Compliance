...
<div class="row mt-2">
    <div class="col-12">
        <a href="/risk_treatment/{{$project_id}}/{{auth()->user()->id}}" class="btn btn-lg btn-secondary text-white w-100">
            <p class="fw-bold" style="text-align:left;">Undertake or view information security risk treatment on the Services and/or assets</p>
        </a>
    </div>
</div>
...
<div class="row mt-2 mb-2">
    <div class="col-12">
        <a href="/iso_section2_4_subsections/{{$project_id}}/{{auth()->user()->id}}" class="btn btn-lg text-white w-100" style="background-color: rgb(244, 113, 134)">
            <p class="fw-bold" style="text-align:left;">Create or edit or view statement of applicability</p>
        </a>
    </div>
</div>
