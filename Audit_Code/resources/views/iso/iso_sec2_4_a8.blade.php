...
@endif
<form action="/iso_sec2_4_a8_new/{{$project_id}}/{{auth()->user()->id}}" method="post">
@csrf
    ...
    <tr style="vertical-align: middle;text-align:initial">
         ...
         @if($results->count()>0)
                ...
                @if($r->control_num===strval($data[$i][0]))
                    ...
                    href="/edit_app_iso_sec2_4_a8/{{$data[$i][0]}}/{{$project_id}}/{{auth()->user()->id}}" class="btn btn-warning btn-sm">
                        Edit
                    </a></span></p>
               ...
               @endif
                ...
                @foreach ($results as $r)
                @if($r->control_num===strval($data[$i][0]))
                <td style="text-align:center"><a href="/iso_sec2_4_a8_edit/{{$data[$i][0]}}/{{$project_id}}/{{auth()->user()->id}}"><i class="fas fa-edit fa-lg" style="color: #114a1d;"></i></a></td>
               @break
                @endif
