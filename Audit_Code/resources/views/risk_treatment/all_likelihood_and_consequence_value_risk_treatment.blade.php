...
<div class="container">
    ...
    <div class="text-end mt-2">
       <a href="/risk_treatment/{{$project->project_id}}/{{auth()->user()->id}}" class="btn btn-secondary btn-md">Back</a>
    </div>
                ...
                <table class="table risk-table">
                    <thead>
                        <tr>
                            ...
                            <th colspan="{{ count($likelihoods) }}" class="header-top">Likelihood ({{$likelihood_timeframe_confidentialilty}} days )</th> <!-- Likelihood label spanning across -->
                        </tr>
                        <tr>
