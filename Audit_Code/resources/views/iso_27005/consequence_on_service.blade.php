            ...
            <td>
                <input class="form-check-input"
                 type="radio" 
                       ...
                       value="{{ $option }}" 
                       {{ (old('risk_confidentiality', $asset->risk_confidentiality ?? '') == $option) ? 'checked' : '' }}>
            </td>
            ...
            <td>
                <input class="form-check-input"
                 type="radio" 
                       name="risk_integrity" 
                       value="{{ $option }}" 
                       {{ (old('risk_integrity', $asset->risk_integrity ?? '') == $option) ? 'checked' : '' }}>
            </td>
            ...
            <td>
                <input class="form-check-input"
                    type="radio" 
                       ...
                       value="{{ $option }}" 
                       {{ (old('risk_availability', $asset->risk_availability ?? '') == $option) ? 'checked' : '' }}>
            </td>

             {{-- Score column with hoverable description --}}
             <td class="score-cell">
            @if($option==5)
            5-Catastrophic
            @elseif($option==4)
