...
<div class="container">
    ...
    <p class="fw-bold fs-5 mt-2 mb-2">Assess Risk  for:</p>
    ...
    <p class="fs-5 mt-4"><span class="fw-bold">Methodology:</span> Qualitative Asset Based</p>
    @endif
    ...
    <p class="fs-5 mt-4"><span class="fw-bold">Methodology:</span> Quantitative Asset Based</p>
    @endif
