...
@php
    $connections=json_decode($data->requirement3)
@endphp

<div class="container">
    <h2 class="text-center">
       Edit Section 3.5 for Project id: {{$project_id}} Project name:{{$project_name}}
        </h2>
...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <form action="/v3_2_s3_3_5_editform/{{$data->assessment_id}}/{{$data->project_id}}/{{auth()->user()->id}}" method="post">
            @csrf
            @method('PUT')
            <div class="form-group">
                <label for="">Identify a Processing and Transmitting Entity </label>
                    <textarea name="requirement1" cols="70" rows="5" class="form-control">{{old('requirement1',$data->requirement1)}}</textarea>
