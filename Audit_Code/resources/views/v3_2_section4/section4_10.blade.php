...
<div class="container">
    ...
    <h2 class="text-center fw-bold">Section 4.10 Individuals interviewed</h2>
        ...
        <div class="card-header bg-primary text-center py-2">
            <h2>Insert details of first individual interviewed</h2>
        </div>
    ...
    <div class="card-body">
        ...
        <form method="post" action="/v3_2_s4_4_10_insert/{{$project_id}}/{{auth()->user()->id}}">
            @csrf
            ...
            @endif
              ...
              <div class="form-group mt-2 col-6">
                ...
                <input type="text" name="requirement4" id="requirement4" class="form-control" value="{{old('requirement4')}}">
            ...
            @endif
              ...
              <div class="form-group mt-2 col-6">
                ...
                <select class="boxstyling bg-primary rounded form-select fw-bold" name="requirement5">
                    ...
                    <option value="yes" {{old('requirement5')=='yes'? 'selected':''}}>Yes</option>
                    <option value="no" {{old('requirement5')=='no'? 'selected':''}}>No</option>
                </select>
        ...
        @if(in_array('Data Inputter',$permissions))
        <a class="btn btn-success btn-md float-end mb-3" href="/v3_2_s4_4_10_new/{{$project_id}}/{{auth()->user()->id}}"
    ...
    <div class="row">
        ...
        <div class="card mb-5">
            ...
            @endisset
             ...
             <label>Is this person an ISA?</label>
           ...
           <label for="">last edited by: </label>
             ...
             <a href="/v3_2_s4_4_10_delete/{{$item->assessment_id}}/{{$item->project_id}}/{{auth()->user()->id}}"
                 class="float-end btn btn-danger btn-md mx-2">Delete</a>

             <a href="/v3_2_s4_4_10_edit/{{$item->assessment_id}}/{{$item->project_id}}/{{auth()->user()->id}}"
