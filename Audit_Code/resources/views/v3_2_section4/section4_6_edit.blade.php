...
<div class="container">
    ...
    <div class="card-header bg-primary text-center py-2">
        <h2>Edit Sample Set {{$data->requirement1}}</h2>
    </div>

    <div class="card-body">


        <form method="post" action="/v3_2_s4_4_6_editform/{{$data->assessment_id}}/{{$data->project_id}}/{{auth()->user()->id}}">
            @csrf
            @method('PUT')
            ...
            @endif
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="requirement6" name='requirement6' value="{{old('requirement6',$data->requirement6)}}">
