...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <form action="/v3_2_s4_4_12_insert/{{$project_id}}/{{auth()->user()->id}}" method="post">
                @csrf
    ...
    {{-- if datainputter --}}
        ...
        @if(in_array('Data Inputter',$permissions))
        <a class="btn btn-success btn-md float-end mb-3" href="/v3_2_s4_4_12_new/{{$project_id}}/{{auth()->user()->id}}"
        ...
        <div class="row">
            ...
            <div class="card mb-5">
                ...
                <label>Identify whether there were any responses indicated as “In Place with Compensating Control.” </label>
                <p><span class="fw-bold">Answer: </span>{{$data1->requirement1}}</p>
                 ...
                 <label>Summary of the issue (legal obligation, etc.)</label>
               ...
               <label for="">last edited by: </label>
                 ...
                 <a href="/v3_2_s4_4_12_delete/{{$item->assessment_id}}/{{$item->project_id}}/{{auth()->user()->id}}"
                     class="float-end btn btn-danger btn-md mx-2">Delete</a>

                 <a href="/v3_2_s4_4_12_edit/{{$item->assessment_id}}/{{$item->project_id}}/{{auth()->user()->id}}"
            ...
            <label for="">Identify whether there were any responses indicated as "In Place with Compensating Control" (yes/no)</label>
            <p><span class="fw-bold">Answer: </span>{{$data1->requirement1}}</p>
            ...
            <a href="/v3_2_s4_4_12_edit_yes_no/{{$data1->project_id}}/{{auth()->user()->id}}"
                class="float-end btn btn-primary btn-md mx-2">Edit</a>
