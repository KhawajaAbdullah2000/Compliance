...
<div class="container">
    ...
    <div class="card-body">
        <form method="post" action="/v3_2_s4_4_8_editform_party/{{$data->assessment_id}}/{{$data->project_id}}/{{auth()->user()->id}}">
            @csrf
            @method('PUT')
          ...
          @endif
            ...
            @endif
              ...
              <div class="form-group mt-2 col-6">
                ...
                <input type="date" class="form-control" name='requirement6' value="{{old('requirement6',$data->requirement6)}}">
