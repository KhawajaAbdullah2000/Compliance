...
<h3 class="text-center">Section 2.3 Asset Id: {{$asset_id}} Control num: {{$control_num}}</h3>
...
<div class="row d-flex justify-content-center">
    ...
    <div class="col-md-6">
        ...
        <form action="/iso_sec_2_3_table_submit/{{$project_id}}/{{auth()->user()->id}}" method="post">
            @csrf
            ...
            @endif
              ...
              <div class="form-group mt-3">
                ...
                <input type="number" name="vulnerability" id="vulnerability" class="form-control" readonly>
              </div>
            ...
            @endif
              ...
              <div class="form-group mt-3">
                ...
                <input type="number" name="risk_level" id="risk_level" class="form-control" readonly>
              </div>
     ...
     @endif
              ...
              <div class="form-group mt-4">
                <label for=""> Treatment Action</label>
                    <input type="text" name="treatment_action" value="{{old('treatment_action')}}">
