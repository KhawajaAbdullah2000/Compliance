...
<div class="col-md-4">
 ...
 <div class="row mt-3 align-items-center">
    ...
    <div class="row h-100 w-100 mb-2">
        <div class="row mt-2 align-items-center" >
            <div class="col-md-6">
         <a href="/ksa_nca_section_2_2/{{4}}/{{$project_id}}/{{auth()->user()->id}}/{{$asset->assessment_id}}" class="btn btn-lg btn-warning w-100"><p class="fw-bold" style="text-align: left;">4. Context of the organization</p></a>
        </div>
        @php
    $title = 4;                             
    $status = $finalStatusByTitle->get($title); 
...
<div class="col-md-4">
    <form action="/add_mandatory_all_title/{{ $project_id }}/{{ auth()->user()->id }}/{{ $asset->assessment_id }}"
        ...
        <div class="row mt-2 align-items-center">
            <div class="col-md-6">
         <a href="/ksa_nca_section_2_2/{{5}}/{{$project_id}}/{{auth()->user()->id}}/{{$asset->assessment_id}}" class="btn btn-lg btn-warning w-100"><p class="fw-bold " style="text-align: left;">5. Leadership</p></a>
        </div>
 ...
 <div class="row mt-3 align-items-center">
    <div class="col-md-6">
        <a href="/ksa_nca_section_2_2/6/{{$project_id}}/{{auth()->user()->id}}/{{$asset->assessment_id}}" class="btn btn-lg btn-warning w-100 text-start fw-bold">
            6. Planning
        </a>
    </div>
    ...
    @endphp
        ...
        <div class="row mt-2 align-items-center">
            <div class="col-md-6">
         <a href="/ksa_nca_section_2_2/{{7}}/{{$project_id}}/{{auth()->user()->id}}/{{$asset->assessment_id}}" class="btn btn-lg btn-warning w-100"><p class="fw-bold " style="text-align: left;">7. Support</p></a>
        </div>
         @php
    $title = 7;                             
    $status = $finalStatusByTitle->get($title); 
    @endphp
        ...
        <div class="row mt-2 align-items-center">
            <div class="col-md-6">
         <a href="/ksa_nca_section_2_2/{{8}}/{{$project_id}}/{{auth()->user()->id}}/{{$asset->assessment_id}}" class="btn btn-lg btn-warning w-100"><p class="fw-bold " style="text-align: left;">8. Operation</p></a>
        </div>
        @php
    $title = 8;                             
    $status = $finalStatusByTitle->get($title); 
    ...
    <form action="/add_mandatory_all_title/{{ $project_id }}/{{ auth()->user()->id }}/{{ $asset->assessment_id }}"
        ...
        <div class="d-flex align-items-center gap-2">
         ...
         <div class="row mt-2 align-items-center">
            <div class="col-md-6">
         <a href="/ksa_nca_section_2_2/{{9}}/{{$project_id}}/{{auth()->user()->id}}/{{$asset->assessment_id}}" class="btn btn-lg btn-warning w-100"><p class="fw-bold " style="text-align: left;">9. Performance Evaluation</p></a>
        </div>
        @php
    $title = 9;                             
    $status = $finalStatusByTitle->get($title); 
    ...
    <form action="/add_mandatory_all_title/{{ $project_id }}/{{ auth()->user()->id }}/{{ $asset->assessment_id }}"
        ...
        <div class="d-flex align-items-center gap-2">
         ...
         <div class="row mt-2 align-items-center">
            <div class="col-md-6">
         <a href="/ksa_nca_section_2_2/{{10}}/{{$project_id}}/{{auth()->user()->id}}/{{$asset->assessment_id}}" class="btn btn-lg btn-warning w-100"><p class="fw-bold " style="text-align: left;">10. Operation</p></a>
        </div>
        @php
    $title = 10;                             
    $status = $finalStatusByTitle->get($title); 
