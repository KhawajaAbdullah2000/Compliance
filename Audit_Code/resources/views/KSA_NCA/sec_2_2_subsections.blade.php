            ...
            <div class="row mt-2 align-items-center">
                <div class="col-md-6">
                    <a href="/ksa_nca_section_2_2/{{ $title }}/{{ $project_id }}/{{ auth()->user()->id }}/{{ $asset->assessment_id }}" 
                       class="btn btn-lg btn-warning w-100">
                        <p class="fw-bold mb-0 text-start">{{ $title }}. {{ $label }}</p>
                    </a>
                </div>
                ...
                <div class="col-md-4">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <select name="comp_statuses[]" class="form-select rounded-pill" style="min-width:150px;">
                            <option value="">Select --</option>
                            @foreach([
                                'yes' => 'In Place',
                                'no' => 'Not in Place',
                        ...
                        <a class="btn btn-sm btn-primary d-flex justify-content-center align-items-center" style="width:100px;" href="#">
                            AI Input
                        </a>
                    ...
                    @if($status === 'different')
                        <span class="badge bg-secondary fs-6 mt-2">Values are different in below levels</span>
                    @endif
                </div>
            </div>
