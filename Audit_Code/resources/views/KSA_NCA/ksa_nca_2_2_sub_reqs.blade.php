...
<div class="container">
    ...
    <a href="/ksa_nca_subsections/{{$project_id}}/{{auth()->user()->id}}" class="btn btn-primary btn-md float-end">Go to All Requirements</a>
    ...
    <table class="table table-bordered table-responsive table-primary">
        ...
        <tbody>
            ...
            <tr>
                ...
                <a href="/ksa_nca_sec2_2_sub_req_edit/{{$d[4]}}/{{$title}}/{{$project_id}}/{{auth()->user()->id}}">
