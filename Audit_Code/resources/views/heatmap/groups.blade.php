                    ...
                    <ul class="list-group">
                        @foreach($groups as $group)
                            <li class="list-group-item">
                                <a href="{{ route('heatmap.service.groups.subgroups', ['service' => $service,'group'=>$group->g_name,'proj_id'=>$project->project_id]) }}">
                                    {{ $group->g_name }}
                                </a>
                            </li>
                        @endforeach
                        ...
                        <li class="list-group-item">
                            <a href="{{ route('heatmap.service.groups.subgroups', ['service' => $service,'group'=>'_all','proj_id'=>$project->project_id]) }}">
                               All Asset Groups
                            </a>
                        </li>
                    </ul>
