                    ...
                    <ul class="list-group">
                        @foreach($subgroups as $subgroup)
                            <li class="list-group-item">
                                <a href="{{ route('heatmap.service.groups.subgroups.components', ['service' => $service,'group'=>$group,'subgroup'=>$subgroup->name,'proj_id'=>$project->project_id]) }}">
                                    {{ $subgroup->name }}
                                </a>
                            </li>
                        ...
                        @endforeach
                        <li class="list-group-item">
                            <a href="{{ route('heatmap.service.groups.subgroups.components', ['service' => $service,'group'=>$group,'subgroup'=>'_all','proj_id'=>$project->project_id]) }}">
                               All Asset Subgroups
                            </a>
                        </li>
                    </ul>
