...
<h3>Select From below and apply to @if(Session('evidenceLevel')=='project') All Services and Assets in this Project @endif
    ...
    <div class="row h-100 w-75">
        <div class="row mt-2" >
         ...
         <a href="/cobit_section_2_2/{{1}}/{{$project_id}}/{{auth()->user()->id}}/{{$asset->assessment_id}}" class="btn btn-lg btn-warning w-100"><p class="fw-bold" style="text-align: left;">Evaluate, Direct and Monitor</p></a>
        </div>
        ...
        <div class="row mt-2">
            <div class="col-md-8">
         <a href="/cobit_section_2_2/{{2}}/{{$project_id}}/{{auth()->user()->id}}/{{$asset->assessment_id}}" class="btn btn-lg btn-warning w-100"><p class="fw-bold " style="text-align: left;">Align, Plan and Organize</p></a>
        </div>
        <div class="col-md-4">
        ...
        <div class="row mt-2">
            <div class="col-md-8">
         <a href="/cobit_section_2_2/{{3}}/{{$project_id}}/{{auth()->user()->id}}/{{$asset->assessment_id}}" class="btn btn-lg btn-warning w-100"><p class="fw-bold " style="text-align: left;">Build, Acquire and Implement</p></a>
        </div>
        <div class="col-md-4">
        ...
        <div class="row mt-2">
            <div class="col-md-8">
         <a href="/cobit_section_2_2/{{4}}/{{$project_id}}/{{auth()->user()->id}}/{{$asset->assessment_id}}" class="btn btn-lg btn-warning w-100"><p class="fw-bold " style="text-align: left;">Deliver, Service and Support</p></a>
        </div>
        <div class="col-md-4">
        ...
        <div class="row mt-2 mb-2">
            <div class="col-md-8">
         <a href="/cobit_section_2_2/{{5}}/{{$project_id}}/{{auth()->user()->id}}/{{$asset->assessment_id}}" class="btn btn-lg btn-warning  w-100"><p class="fw-bold " style="text-align: left;">Monitor, Evaluate and Assess</p></a>
        </div>
