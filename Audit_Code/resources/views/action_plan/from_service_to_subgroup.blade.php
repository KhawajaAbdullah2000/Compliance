...
<div class="container my-2">
    ...
    <h3 class="fw-bold text-center mt-4 mb-4">View or {{$actionPlanType}} Download  Action Plan
    </h3>
                    ...
                    <ul class="list-group">
                        @foreach($subgroups as $subgroup)
                            <li class="list-group-item">
                                <a href="{{ route('action_plan_service_subgroups_to_components', ['service' => $service,'subgroup'=>$subgroup->name,'proj_id'=>$project->project_id]) }}">
                                    {{ $subgroup->name }}
                                </a>
                            </li>
                        @endforeach
                        <li class="list-group-item">
                            <a href="{{ route('action_plan_service_subgroups_to_components', ['service' => $service,'subgroup'=>'_all','proj_id'=>$project->project_id]) }}">
                                All Asset Subgroups
                            </a>
                        </li>
                    </ul>
