...
{
    public function ksa_nca_subsections($proj_id,$user_id){
    ...
    public function ksa_nca_section_2_2($title_num, $proj_id, $user_id){
    ...
    public function ksa_nca_sec_2_2_req(Request $req,$main_req_num,$title,$proj_id,$user_id){
        if ($user_id == auth()->user()->id) {
            $checkpermission = Db::table('project_details')->select(
                'project_types.id as type_id',
                'project_details.project_code',
    ...
    public function ksa_nca_sec2_2_sub_req_edit(Request $req,$sub_req,$title,$proj_id,$user_id){
        if ($user_id == auth()->user()->id) {
            $checkpermission = Db::table('project_details')->select(
                'project_types.id as type_id',
                'project_details.project_code',
    ...
    public function ksa_nca_sec_2_2_form(Request $req,$sub_req,$title,$proj_id,$user_id){
        $req->validate([
          ...
          if ($user_id == auth()->user()->id) {
            ...
            if ($checkpermission) {
                ...
                if ($checkpermission->type_id ==7) {
                 ...
                 return redirect()->route('ksa_nca_sec_2_2_req',
    ...
    public function ksa_nca_sec_2_2_edit_form(Request $req,$sub_req,$title,$proj_id,$user_id){
        $req->validate([
            'comp_status'=>'required'
          ]);
          if ($user_id == auth()->user()->id) {
