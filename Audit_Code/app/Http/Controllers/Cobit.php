...
class Cobit extends Controller
{
    public function cobit_subsections($proj_id, $user_id, $asset_id, Request $req)
    {
        if ($user_id == auth()->user()->id) {
            ...
            if ($checkpermission) {
                ...
                if ($checkpermission->type_id == 16
                    ...
                    return view('cobit.sec_2_2_subsections', [
    ...
    public function cobit_section_2_2($title_num, $proj_id, $user_id, $asset_id)
    {
        if ($user_id == auth()->user()->id) {
            $checkpermission = Db::table('project_details')->select(
                'project_types.id as type_id',
            ...
            if ($checkpermission) {
                ...
                if ($checkpermission->type_id == 16) {
                    ...
                    return view('cobit.cobit_sec_2_2_main', [
                        'project_id' => $checkpermission->project_id,
                        'project_name' => $checkpermission->project_name,
    ...
    public function cobit_sec_2_2_req(Request $req, $main_req_num, $title, $proj_id, $user_id, $asset_id)
    {
        if ($user_id == auth()->user()->id) {
            $checkpermission = Db::table('project_details')->select(
                'project_types.id as type_id',
            ...
            if ($checkpermission) {
                ...
                if ($checkpermission->type_id == 16) {
                    ...
                    return view('cobit.cobit_2_2_sub_reqs', [
                        'project_id' => $checkpermission->project_id,
                        'project_name' => $checkpermission->project_name,
                        'project_permissions' => $checkpermission->project_permissions,
                        'data' => $filteredData,
    ...
    public function cobit_sec2_2_sub_req_edit($sub_req, $title, $proj_id, $user_id, $asset_id)
    {
        ...
        if ($user_id == auth()->user()->id) {
            ...
            if ($checkpermission) {
                ...
                return view('cobit.cobit_sec_2_2_sub_reqs_form', [
                    'project_id' => $checkpermission->project_id,
                    'project_name' => $checkpermission->project_name,
                    'project_permissions' => $checkpermission->project_permissions,
                    'title' => $title,
    ...
    public function cobit_sec_2_2_form(Request $req, $sub_req, $title, $proj_id, $user_id, $asset_id)
    {
        $req->validate([
