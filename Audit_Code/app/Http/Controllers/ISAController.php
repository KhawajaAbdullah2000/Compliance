...
{
    public function isa_subsections(Request $req, $proj_id, $user_id, $asset_id)
    {
        ...
        if ($user_id == auth()->user()->id) {
            ...
            if ($checkpermission) {
                ...
                if ($checkpermission->type_id == 10) {
                    return view('isa.isa_3_2_sec_2_2_subsections', [
                        'project_id' => $checkpermission->project_id,
                        'project_name' => $checkpermission->project_name,
                        'project' => $project,
                        'asset' => $asset
                 ...
                 if ($checkpermission->type_id == 12) {
                    return view('isa.isa_4_2_sec_2_2_subsections', [
                        'project_id' => $checkpermission->project_id,
                        'project_name' => $checkpermission->project_name,
                        'project' => $project,
                        'asset' => $asset
                ...
                if ($checkpermission->type_id == 13) {
                    return view('isa.isa_3_3_sec_2_2_subsections', [
                        'project_id' => $checkpermission->project_id,
                        'project_name' => $checkpermission->project_name,
                        'project' => $project,
                        'asset' => $asset
    ...
    public function isa_section_2_2($title_num, $proj_id, $user_id, $asset_id)
    {
    ...
    public function isa_sec_2_2_req(Request $req, $main_req_num, $title, $proj_id, $user_id, $asset_id)
    {
        if ($user_id == auth()->user()->id) {
            $checkpermission = Db::table('project_details')->select(
                'project_types.id as type_id',
            ...
            if ($checkpermission) {
                ...
                if ($checkpermission->type_id ==11) {
                    ...
                    return view('isa.isa_2_2_sub_reqs', [
                        'project_id' => $checkpermission->project_id,
                        'project_name' => $checkpermission->project_name,
                        'project_permissions' => $checkpermission->project_permissions,
                        'data' => $filteredData,
    ...
    public function isa_sec2_2_sub_req_edit(Request $req, $sub_req, $title, $proj_id, $user_id, $asset_id)
    {
        if ($user_id == auth()->user()->id) {
            $checkpermission = Db::table('project_details')->select(
                'project_types.id as type_id',
    ...
    public function isa_sec_2_2_form(Request $req, $sub_req, $title, $proj_id, $user_id, $asset_id)
    {
        $req->validate([
                ...
                $permissions = json_decode($checkpermission->project_permissions);
                    ...
                    if (in_array('Data Inputter', $permissions)) {
                        ...
                        if ($req->attachment != null) {
                            ...
                            $req->attachment->move(public_path('isa_sec_2_2'), $fileName);
                            $data = [
