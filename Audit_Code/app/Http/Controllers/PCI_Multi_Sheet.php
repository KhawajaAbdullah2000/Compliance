...
class PCI_Multi_Sheet extends Controller
{
    public function pci_multi_sheet_subsections($proj_id,$user_id){
        ...
        if ($user_id == auth()->user()->id) {
            ...
            if ($checkpermission) {
                ...
                if ($checkpermission->type_id == 2) {
                    ...
                    return view('pci_multi_sheet.sec_2_2_subsections', [
    ...
    public function pci_multi_section_2_2($title_num, $proj_id, $user_id){
            ...
            if ($checkpermission) {
                ...
                if ($checkpermission->type_id == 2) {
                   ...
                   $filteredData = collect($data[0])->filter(function ($row) use ($title_num) {
                    ...
                    return view('pci_multi_sheet.pci_sec_2_2_main', [
                    'project_id' => $checkpermission->project_id,
                   'project_name' => $checkpermission->project_name,
    ...
    public function pci_multi_sec_2_2_req(Request $req,$main_req_num,$title,$proj_id,$user_id){
        if ($user_id == auth()->user()->id) {
            $checkpermission = Db::table('project_details')->select(
                'project_types.id as type_id',
                'project_details.project_code',
            ...
            if ($checkpermission) {
                ...
                ->where('projects.project_id',$proj_id)->first();
                    ...
                    return view('pci_multi_sheet.pci_2_2_sub_reqs', [
                    'project_id' => $checkpermission->project_id,
                   'project_name' => $checkpermission->project_name,
                   'project_permissions'=>$checkpermission->project_permissions,
                   'data'=>$filteredData,
    ...
    public function pci_multi_sec2_2_sub_req_edit($sub_req,$title,$proj_id,$user_id){
        if ($user_id == auth()->user()->id) {
            $checkpermission = Db::table('project_details')->select(
                'project_types.id as type_id',
                'project_details.project_code',
    ...
    public function pci_multi_sec_2_2_form(Request $req,$sub_req,$title,$proj_id,$user_id){
        $req->validate([
          ...
          if ($user_id == auth()->user()->id) {
            ...
            if ($checkpermission) {
                ...
                if ($checkpermission->type_id == 2) {
                 ...
                 return redirect()->route('pci_multi_sec_2_2_req',
    ...
    public function pci_multi_sec_2_2_edit_form(Request $req,$sub_req,$title,$proj_id,$user_id){
        $req->validate([
            'comp_status'=>'required'
          ]);
          if ($user_id == auth()->user()->id) {
