...
class SBP_ETGRMF extends Controller
{
    public function sbp_etgrmf_subsections(Request $req,$proj_id,$user_id,$asset_id){
        ...
        if ($user_id == auth()->user()->id) {
            ...
            if ($checkpermission) {
                ...
                if ($checkpermission->type_id == 6) {
                    ...
                    return view('SBP_ETGRMF.sec_2_2_subsections', [
    ...
    public function sbp_etgrmf_section_2_2($title_num, $proj_id, $user_id,$asset_id){
        ...
        if ($user_id == auth()->user()->id) {
            ...
            if ($checkpermission) {
                ...
                $asset = Db::table('iso_sec_2_1')->where('assessment_id', $asset_id)->first();
                    ...
                    return view('SBP_ETGRMF.sbp_etgrmf_2_2_main', [
                    'project_id' => $checkpermission->project_id,
                   'project_name' => $checkpermission->project_name,
    ...
    public function sbp_etgrmf_sec_2_2_req(Request $req,$main_req_num,$title,$proj_id,$user_id,$asset_id){
        if ($user_id == auth()->user()->id) {
            $checkpermission = Db::table('project_details')->select(
                'project_types.id as type_id',
                'project_details.project_code',
            ...
            if ($checkpermission) {
                ...
                $asset = Db::table('iso_sec_2_1')->where('assessment_id', $asset_id)->first();
                    ...
                    return view('SBP_ETGRMF.sbp_etgrmf_2_2_sub_reqs', [
                    'project_id' => $checkpermission->project_id,
                   'project_name' => $checkpermission->project_name,
                   'project_permissions'=>$checkpermission->project_permissions,
                   'data'=>$filteredData,
    ...
    public function sbp_etgrmf_sec2_2_sub_req_edit(Request $req,$sub_req,$title,$proj_id,$user_id,$asset_id){
        if ($user_id == auth()->user()->id) {
            $checkpermission = Db::table('project_details')->select(
                'project_types.id as type_id',
                'project_details.project_code',
    ...
    public function sbp_etgrmf_sec_2_2_form(Request $req, $sub_req, $title, $proj_id, $user_id,$asset_id)
    {
        $req->validate([
                ...
                if ($checkpermission->type_id == 6) {
                    ...
                    if (in_array('Data Inputter', $permissions)) {
                        ...
                        if ($req->attachment != null) {
                            ...
                            $req->attachment->move(public_path('sbp_etgrmf_sec_2_2'), $fileName);
                        }
    ...
    public function sbp_etgrmf_sec_2_2_edit_form(Request $req, $sub_req, $title, $proj_id, $user_id,$asset_id)
    {
        $req->validate([
            'comp_status' => 'required'
        ]);
