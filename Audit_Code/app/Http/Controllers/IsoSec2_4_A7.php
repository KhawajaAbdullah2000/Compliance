...
class IsoSec2_4_A7 extends Controller
{
    ...
    public function iso_sec2_4_a7_assets($proj_id, $user_id)
    {
    ...
    public function iso_sec2_4_a7($asset_id, $proj_id, $user_id)
    {
        if ($user_id == auth()->user()->id) {
            $checkpermission = Db::table('project_details')->select(
                'project_types.id as type_id',
    ...
    public function iso_sec2_4_a7_edit($control_num, $asset_id, $proj_id, $user_id)
    {
            ...
            if ($checkpermission) {
                ...
                if (in_array('Data Inputter', $permissions)) {
                    if ($checkpermission->type_id == 4) {
                        ...
                        $control_data = Db::table('iso_sec2_4_a7')->where('asset_id', $asset_id)
                            ->where('control_num', $control_num)->where('project_id', $proj_id)->first();
    ...
    public function submit_edit_sec2_4_a7(Request $req, $control_num, $asset_id, $proj_id, $user_id)
    {
            ...
            if ($checkpermission) {
                ...
                if (in_array('Data Inputter', $permissions)) {
                    if ($checkpermission->type_id == 4) {
                        ...
                        $exists = DB::table('iso_sec2_4_a7')->where('control_num', $control_num)->where('project_id', $proj_id)
                            ->where('asset_id', $asset_id)->first();
                        if ($exists) {

                            if ($check->applicability == "yes") {

                                Db::table('iso_sec2_4_a7')->where('project_id', $proj_id)->where('asset_id', $asset_id)
                                ...
                                return redirect()->route('iso_sec2_4_a7', ['asset_id' => $asset_id, 'proj_id' => $proj_id, 'user_id' => $user_id])
