...
//section4.9
public function v3_2_s4_4_9($proj_id,$user_id){
    if($user_id==auth()->user()->id){
        $checkpermission=Db::table('project_details')->select('project_types.id as type_id','project_details.project_code',
    'project_details.project_permissions','projects.project_name','projects.project_id')
   -> join('projects','project_details.project_code','projects.project_id')
    ...
    if($checkpermission){
                ...
                if($checkpermission->type_id==2){
                   $data=DB::table('pci-dss v3_2_1 sec4_9')->join('users','pci-dss v3_2_1 sec4_9.last_edited_by',
                   'users.id')->where('project_id',$proj_id)->get();


                   return view('v3_2_section4.section4_9',[
                    'data'=>$data,
                    'project_id'=>$checkpermission->project_id,
                    'project_name'=>$checkpermission->project_name,
                    'project_permissions'=>$checkpermission->project_permissions
...
public function v3_2_s4_4_9_insert(Request $req,$proj_id,$user_id){
    $req->validate([
        'requirement1'=>'max:300',
        'requirement2'=>'required|max:300',
        'requirement3'=>'required|max:1000',
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                    ...
                    Db::table('pci-dss v3_2_1 sec4_9')->insert([
                        'project_id'=>$proj_id,
                        'requirement1'=>$req->requirement1,
                        'requirement2'=>$req->requirement2,
                        'requirement3'=>$req->requirement3,
                   ...
                   return redirect()->route('section4_9',['proj_id'=>$proj_id,'user_id'=>$user_id])
                   ->with('success','Record Added successfully');
...
public function v3_2_s4_4_9_new($proj_id,$user_id){
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                return view('v3_2_section4.section4_9_new',[
                    'project_id'=>$proj_id,
                    'project_name'=>$checkpermission->project_name
...
public function v3_2_s4_4_9_edit($assessment_id,$proj_id,$user_id){
   ...
   -> join('projects','project_details.project_code','projects.project_id')
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                   $data=DB::table('pci-dss v3_2_1 sec4_9')->where('assessment_id',$assessment_id)
                   ->where('project_id',$proj_id)->first();
                   if($data){
                    return view('v3_2_section4.section4_9_edit',[
                        'data'=>$data,
                        'project_id'=>$checkpermission->project_id,
                        'project_name'=>$checkpermission->project_name,
                       ]);
...
public function v3_2_s4_4_9_editform(Request $req,$assessment_id,$proj_id,$user_id){
    $req->validate([
        'requirement1'=>'max:300',
        'requirement2'=>'required|max:300',
        'requirement3'=>'required|max:1000',
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                    ...
                    Db::table('pci-dss v3_2_1 sec4_9')->where('assessment_id',$assessment_id)->where('project_id',$proj_id)
                    ->update([
                        'requirement1'=>$req->requirement1,
                        'requirement2'=>$req->requirement2,
                        'requirement3'=>$req->requirement3,
...
public function v3_2_s4_4_9_delete($assessment_id,$proj_id,$user_id){
    if($user_id==auth()->user()->id){
        $checkpermission=Db::table('project_details')->select('project_types.id as type_id','project_details.project_code',
    'project_details.project_permissions','projects.project_name','projects.project_id')
    -> join('projects','project_details.project_code','projects.project_id')
...
public function v3_2_s4_4_10($proj_id,$user_id){
    if($user_id==auth()->user()->id){
        $checkpermission=Db::table('project_details')->select('project_types.id as type_id','project_details.project_code',
    'project_details.project_permissions','projects.project_name','projects.project_id')
   -> join('projects','project_details.project_code','projects.project_id')
    ...
    if($checkpermission){
                ...
                if($checkpermission->type_id==2){
                   $data=DB::table('pci-dss v3_2_1 sec4_10')->join('users','pci-dss v3_2_1 sec4_10.last_edited_by',
                   'users.id')->where('project_id',$proj_id)->get();

                   return view('v3_2_section4.section4_10',[
                    'data'=>$data,
                    'project_id'=>$checkpermission->project_id,
                    'project_name'=>$checkpermission->project_name,
                    'project_permissions'=>$checkpermission->project_permissions
...
public function v3_2_s4_4_10_insert(Request $req,$proj_id,$user_id){
    $req->validate([
        'requirement1'=>'max:300',
        'requirement2'=>'required|max:300',
        'requirement3'=>'required|max:300',
        'requirement4'=>'required|max:300',
        'requirement5'=>'required|max:3'
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                    ...
                    Db::table('pci-dss v3_2_1 sec4_10')->insert([
                        'project_id'=>$proj_id,
                        'requirement1'=>$req->requirement1,
                        'requirement2'=>$req->requirement2,
                        'requirement3'=>$req->requirement3,
                   ...
                   return redirect()->route('section4_10',['proj_id'=>$proj_id,'user_id'=>$user_id])
                   ->with('success','Record Added successfully');
...
public function v3_2_s4_4_10_new($proj_id,$user_id){
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                return view('v3_2_section4.section4_10_new',[
                    'project_id'=>$proj_id,
                    'project_name'=>$checkpermission->project_name
...
public function v3_2_s4_4_10_edit($assessment_id,$proj_id,$user_id){
   ...
   -> join('projects','project_details.project_code','projects.project_id')
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                   $data=DB::table('pci-dss v3_2_1 sec4_10')->where('assessment_id',$assessment_id)
                   ->where('project_id',$proj_id)->first();
                   if($data){
                    return view('v3_2_section4.section4_10_edit',[
                        'data'=>$data,
                        'project_id'=>$checkpermission->project_id,
                        'project_name'=>$checkpermission->project_name,
                       ]);
...
public function v3_2_s4_4_10_editform(Request $req,$assessment_id,$proj_id,$user_id){
    $req->validate([
        'requirement1'=>'max:300',
        'requirement2'=>'required|max:300',
        'requirement3'=>'required|max:300',
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                    ...
                    Db::table('pci-dss v3_2_1 sec4_10')->where('assessment_id',$assessment_id)->where('project_id',$proj_id)
                    ->update([
                        'requirement1'=>$req->requirement1,
                        'requirement2'=>$req->requirement2,
                        'requirement3'=>$req->requirement3,
...
public function v3_2_s4_4_10_delete($assessment_id,$proj_id,$user_id){
...
//section4.11
public function v3_2_s4_4_11($proj_id,$user_id){
    if($user_id==auth()->user()->id){
        $checkpermission=Db::table('project_details')->select('project_types.id as type_id','project_details.project_code',
    'project_details.project_permissions','projects.project_name','projects.project_id')
   -> join('projects','project_details.project_code','projects.project_id')
    ...
    if($checkpermission){
                ...
                if($checkpermission->type_id==2){
                   $data=DB::table('pci-dss v3_2_1 sec4_11')->join('users','pci-dss v3_2_1 sec4_11.last_edited_by',
                   'users.id')->where('project_id',$proj_id)->first();

                   return view('v3_2_section4.section4_11',[
                    'data'=>$data,
                    'project_id'=>$checkpermission->project_id,
                    'project_name'=>$checkpermission->project_name,
                    'project_permissions'=>$checkpermission->project_permissions
...
public function v3_2_s4_4_11_insert(Request $req,$proj_id,$user_id){

    $req->validate([
        'requirement1'=>'required|max:3',
        'requirement2'=>'max:1000',
        'requirement3'=>'max:1000',
        'requirement4'=>'max:1000',
        'requirement5'=>'max:1000',
        'requirement6'=>'max:1000',
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                    ...
                    if($req->requirement1=="no"){
                        Db::table('pci-dss v3_2_1 sec4_11')->insert([
                            'project_id'=>$proj_id,
                            'requirement1'=>$req->requirement1,
                            'requirement2'=>null,
                            'requirement3'=>null,
                   ...
                   return redirect()->route('section4_11',['proj_id'=>$proj_id,'user_id'=>$user_id])
                   ->with('success','Record Added successfully');
...
public function v3_2_s4_4_11_edit($assessment_id,$proj_id,$user_id) {
    if($user_id==auth()->user()->id){
        $checkpermission=Db::table('project_details')->select('project_types.id as type_id','project_details.project_code',
    'project_details.project_permissions','projects.project_name','projects.project_id')
   -> join('projects','project_details.project_code','projects.project_id')
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                   $data=DB::table('pci-dss v3_2_1 sec4_11')->where('assessment_id',$assessment_id)
                   ->where('project_id',$proj_id)->first();
                   if($data){
                    return view('v3_2_section4.section4_11_edit',[
                        'data'=>$data,
                        'project_id'=>$checkpermission->project_id,
                        'project_name'=>$checkpermission->project_name,
                       ]);
...
public function v3_2_s4_4_11_editform(Request $req,$assessment_id,$proj_id,$user_id){
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                    ...
                    if($req->requirement1=="no"){
                        Db::table('pci-dss v3_2_1 sec4_11')->where('assessment_id',$assessment_id)->where('project_id',$proj_id)
                        ->update([
                            'requirement1'=>$req->requirement1,
                            'requirement2'=>null,
                            'requirement3'=>null,
...
//section4.12
public function v3_2_s4_4_12($proj_id,$user_id){
    if($user_id==auth()->user()->id){
        $checkpermission=Db::table('project_details')->select('project_types.id as type_id','project_details.project_code',
    'project_details.project_permissions','projects.project_name','projects.project_id')
   -> join('projects','project_details.project_code','projects.project_id')
    ...
    if($checkpermission){
                ...
                if($checkpermission->type_id==2){
                   $data1=DB::table('pci-dss v3_2_1 sec4_12_yes_or_no')
                   ->join('users','pci-dss v3_2_1 sec4_12_yes_or_no.last_edited_by',
                   'users.id')->where('project_id',$proj_id)->first();

                   $data2=DB::table('pci-dss v3_2_1 sec4_12_table')
                   ->join('users','pci-dss v3_2_1 sec4_12_table.last_edited_by',
                   'users.id')->where('project_id',$proj_id)->get();



                   return view('v3_2_section4.section4_12',[
                    'data1'=>$data1,
                    'data2'=>$data2,
                    'project_id'=>$checkpermission->project_id,
                    'project_name'=>$checkpermission->project_name,
...
public function v3_2_s4_4_12_insert(Request $req,$proj_id,$user_id){

    $req->validate([
        'requirement1'=>'required|max:3',
        'requirement2'=>'max:500',
        'requirement3'=>'max:1000'
    ],[
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                    ...
                    Db::table('pci-dss v3_2_1 sec4_12_yes_or_no')->insert([
                        'project_id'=>$proj_id,
                        'requirement1'=>$req->requirement1,
                        'last_edited_by'=>$user_id,
                        'last_edited_at'=>Carbon::now()->format('Y-m-d H:i:s')
                    ...
                    if($req->requirement1=="yes"){
                        Db::table('pci-dss v3_2_1 sec4_12_table')->insert([
                            'project_id'=>$proj_id,
                            'requirement2'=>$req->requirement2,
                            'requirement3'=>$req->requirement3,
                            'last_edited_by'=>$user_id,
                   ...
                   return redirect()->route('section4_12',['proj_id'=>$proj_id,'user_id'=>$user_id])
                   ->with('success','Record Added successfully');
...
public function v3_2_s4_4_12_new($proj_id,$user_id){
    if($user_id==auth()->user()->id){
        $checkpermission=Db::table('project_details')->select('project_types.id as type_id','project_details.project_code',
    'project_details.project_permissions','projects.project_name','projects.project_id')
    -> join('projects','project_details.project_code','projects.project_id')
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                return view('v3_2_section4.section4_12_new',[
                    'project_id'=>$proj_id,
                    'project_name'=>$checkpermission->project_name
...
public function v3_2_s4_4_12_insert_new(Request $req,$proj_id,$user_id){
    $req->validate([
        'requirement2'=>'required|max:500',
        'requirement3'=>'required|max:1000',
...
public function v3_2_s4_4_12_edit($assessment_id,$proj_id,$user_id){
   ...
   -> join('projects','project_details.project_code','projects.project_id')
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                   $data=DB::table('pci-dss v3_2_1 sec4_12_table')->where('assessment_id',$assessment_id)
                   ->where('project_id',$proj_id)->first();
                   if($data){
                    return view('v3_2_section4.section4_12_edit',[
                        'data'=>$data,
                        'project_id'=>$checkpermission->project_id,
                        'project_name'=>$checkpermission->project_name,
                       ]);
...
public function v3_2_s4_4_12_editform(Request $req,$assessment_id,$proj_id,$user_id){
    $req->validate([
        'requirement2'=>'required|max:500',
        'requirement3'=>'required|max:1000',
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                    ...
                    Db::table('pci-dss v3_2_1 sec4_12_table')->where('assessment_id',$assessment_id)->where('project_id',$proj_id)
                    ->update([
                        'requirement2'=>$req->requirement2,
                        'requirement3'=>$req->requirement3,
                        'last_edited_by'=>$user_id,
...
public function v3_2_s4_4_12_delete($assessment_id,$proj_id,$user_id){
    if($user_id==auth()->user()->id){
        $checkpermission=Db::table('project_details')->select('project_types.id as type_id','project_details.project_code',
    'project_details.project_permissions','projects.project_name','projects.project_id')
    -> join('projects','project_details.project_code','projects.project_id')
...
public function v3_2_s4_4_12_edit_yes_no($proj_id,$user_id){
    if($user_id==auth()->user()->id){
        $checkpermission=Db::table('project_details')->select('project_types.id as type_id','project_details.project_code',
    'project_details.project_permissions','projects.project_name','projects.project_id')
   -> join('projects','project_details.project_code','projects.project_id')
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                   $data=DB::table('pci-dss v3_2_1 sec4_12_yes_or_no')
                   ->where('project_id',$proj_id)->first();
                   if($data){
                    return view('v3_2_section4.section4_12_yes_no_edit',[
                        'data'=>$data,
                        'project_id'=>$checkpermission->project_id,
                        'project_name'=>$checkpermission->project_name,
                       ]);
...
public function v3_2_s4_4_12_yes_no_editform(Request $req,$proj_id,$user_id){
    $req->validate([
        'requirement1'=>'required|max:3',
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                    ...
                    Db::table('pci-dss v3_2_1 sec4_12_yes_or_no')->where('project_id',$proj_id)->delete();

                    Db::table('pci-dss v3_2_1 sec4_12_yes_or_no')->where('project_id',$proj_id)
                    ->insert([
                        'project_id'=>$proj_id,
                        'requirement1'=>$req->requirement1,
                        'last_edited_by'=>$user_id,
...
public function v3_2_s4_4_13($proj_id,$user_id){
    if($user_id==auth()->user()->id){
        $checkpermission=Db::table('project_details')->select('project_types.id as type_id','project_details.project_code',
    'project_details.project_permissions','projects.project_name','projects.project_id')
   -> join('projects','project_details.project_code','projects.project_id')
    ...
    if($checkpermission){
                ...
                if($checkpermission->type_id==2){
                   $data1=DB::table('pci-dss v3_2_1 sec4_13_yes_or_no')
                   ->join('users','pci-dss v3_2_1 sec4_13_yes_or_no.last_edited_by',
                   'users.id')->where('project_id',$proj_id)->first();

                   $data2=DB::table('pci-dss v3_2_1 sec4_13_table')
                   ->join('users','pci-dss v3_2_1 sec4_13_table.last_edited_by',
                   'users.id')->where('project_id',$proj_id)->get();



                   return view('v3_2_section4.section4_13',[
                    'data1'=>$data1,
                    'data2'=>$data2,
                    'project_id'=>$checkpermission->project_id,
                    'project_name'=>$checkpermission->project_name,
...
public function v3_2_s4_4_13_insert(Request $req,$proj_id,$user_id){
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                    ...
                    Db::table('pci-dss v3_2_1 sec4_13_yes_or_no')->insert([
                        'project_id'=>$proj_id,
                        'requirement1'=>$req->requirement1,
                        'last_edited_by'=>$user_id,
                        'last_edited_at'=>Carbon::now()->format('Y-m-d H:i:s')
                    ...
                    if($req->requirement1=="yes"){
                        Db::table('pci-dss v3_2_1 sec4_13_table')->insert([
                            'project_id'=>$proj_id,
                            'requirement2'=>$req->requirement2,
                            'requirement3'=>$req->requirement3,
                            'last_edited_by'=>$user_id,
                   ...
                   return redirect()->route('section4_13',['proj_id'=>$proj_id,'user_id'=>$user_id])
                   ->with('success','Record Added successfully');
...
public function v3_2_s4_4_13_new($proj_id,$user_id){
    if($user_id==auth()->user()->id){
        $checkpermission=Db::table('project_details')->select('project_types.id as type_id','project_details.project_code',
    'project_details.project_permissions','projects.project_name','projects.project_id')
    -> join('projects','project_details.project_code','projects.project_id')
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                return view('v3_2_section4.section4_13_new',[
                    'project_id'=>$proj_id,
                    'project_name'=>$checkpermission->project_name
...
public function v3_2_s4_4_13_insert_new(Request $req,$proj_id,$user_id){
    $req->validate([
        'requirement2'=>'required|max:500',
        'requirement3'=>'required|max:1000',
...
public function v3_2_s4_4_13_edit($assessment_id,$proj_id,$user_id){
   ...
   -> join('projects','project_details.project_code','projects.project_id')
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                   $data=DB::table('pci-dss v3_2_1 sec4_13_table')->where('assessment_id',$assessment_id)
                   ->where('project_id',$proj_id)->first();
                   if($data){
                    return view('v3_2_section4.section4_13_edit',[
                        'data'=>$data,
                        'project_id'=>$checkpermission->project_id,
                        'project_name'=>$checkpermission->project_name,
                       ]);
...
public function v3_2_s4_4_13_editform(Request $req,$assessment_id,$proj_id,$user_id){
    $req->validate([
        'requirement2'=>'required|max:500',
        'requirement3'=>'required|max:1000',
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                    ...
                    Db::table('pci-dss v3_2_1 sec4_13_table')->where('assessment_id',$assessment_id)->where('project_id',$proj_id)
                    ->update([
                        'requirement2'=>$req->requirement2,
                        'requirement3'=>$req->requirement3,
                        'last_edited_by'=>$user_id,
...
public function v3_2_s4_4_13_delete($assessment_id,$proj_id,$user_id){
    if($user_id==auth()->user()->id){
        $checkpermission=Db::table('project_details')->select('project_types.id as type_id','project_details.project_code',
    'project_details.project_permissions','projects.project_name','projects.project_id')
    -> join('projects','project_details.project_code','projects.project_id')
...
public function v3_2_s4_4_13_edit_yes_no($proj_id,$user_id){
    if($user_id==auth()->user()->id){
        $checkpermission=Db::table('project_details')->select('project_types.id as type_id','project_details.project_code',
    'project_details.project_permissions','projects.project_name','projects.project_id')
   -> join('projects','project_details.project_code','projects.project_id')
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                   $data=DB::table('pci-dss v3_2_1 sec4_13_yes_or_no')
                   ->where('project_id',$proj_id)->first();
                   if($data){
                    return view('v3_2_section4.section4_13_yes_no_edit',[
                        'data'=>$data,
                        'project_id'=>$checkpermission->project_id,
                        'project_name'=>$checkpermission->project_name,
                       ]);
...
public function v3_2_s4_4_13_yes_no_editform(Request $req,$proj_id,$user_id){
    $req->validate([
        'requirement1'=>'required|max:3',
    ...
    if($checkpermission){
        ...
        if(in_array('Data Inputter',$permissions)){
                if($checkpermission->type_id==2){
                    ...
                    Db::table('pci-dss v3_2_1 sec4_13_yes_or_no')->where('project_id',$proj_id)->delete();

                    Db::table('pci-dss v3_2_1 sec4_13_yes_or_no')->where('project_id',$proj_id)
                    ->insert([
                        'project_id'=>$proj_id,
                        'requirement1'=>$req->requirement1,
                        'last_edited_by'=>$user_id,
