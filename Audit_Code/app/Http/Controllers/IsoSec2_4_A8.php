...
{
    public function iso_sec2_4_a8_assets($proj_id, $user_id)
    {
        ...
        if ($user_id == auth()->user()->id) {
            ...
            if ($checkpermission) {
                ...
                if ($checkpermission->type_id == 4) {
                    ...
                    return view('iso.iso_sec_2_7_assets_main', [
                        'data' => $data,
    ...
    public function iso_sec2_4_a8($asset_id, $proj_id, $user_id)
    {
        if ($user_id == auth()->user()->id) {
            $checkpermission = Db::table('project_details')->select(
                'project_types.id as type_id',
    ...
    public function iso_sec2_4_a8_edit($control_num, $asset_id, $proj_id, $user_id)
    {
            ...
            if ($checkpermission) {
                ...
                if (in_array('Data Inputter', $permissions)) {
                    if ($checkpermission->type_id == 4) {
                        ...
                        $control_data = Db::table('iso_sec2_4_a8')->where('asset_id', $asset_id)
                            ->where('control_num', $control_num)->where('project_id', $proj_id)->first();
    ...
    public function submit_edit_sec2_4_a8(Request $req, $control_num, $asset_id, $proj_id, $user_id)
    {
            ...
            if ($checkpermission) {
                ...
                if (in_array('Data Inputter', $permissions)) {
                    if ($checkpermission->type_id == 4) {
                        ...
                        $exists = DB::table('iso_sec2_4_a8')->where('control_num', $control_num)->where('project_id', $proj_id)
                            ->where('asset_id', $asset_id)->first();
                        if ($exists) {

                            if ($check->applicability == "yes") {

                                Db::table('iso_sec2_4_a8')->where('project_id', $proj_id)->where('asset_id', $asset_id)
                                ...
                                return redirect()->route('iso_sec2_4_a8', ['asset_id' => $asset_id, 'proj_id' => $proj_id, 'user_id' => $user_id])
