...
return new class extends Migration
{
    ...
    {
        Schema::create('internal_audit_strategy', function (Blueprint $table) {
            ...
            $table->foreign(['last_edited_by'], 'last_ed_inter_aud_fk2')->references(['id'])->on('users')->onUpdate('CASCADE')->onDelete('SET NULL');
    ...
    $table->foreign(['project_id'], 'projid_audit_interfk3')->references(['project_id'])->on('projects')->onUpdate('CASCADE')->onDelete('CASCADE');
    ...
    {
        Schema::dropIfExists('internal_audit_strategy');
    }
};
