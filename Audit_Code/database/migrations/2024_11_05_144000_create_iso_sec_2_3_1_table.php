...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('iso_sec_2_3_1', function (Blueprint $table) {
            ...
            $table->string('desc_vulnerability', 500)->default('Description of control is fully met');
            $table->string('desc_vulnerability_other', 300)->nullable();
            $table->integer('vulnerability')->nullable();
            $table->string('desc_threat', 500)->default('Asset component is directly publicly exposed');
            $table->string('desc_threat_other', 500)->nullable();
            ...
            $table->longText('desc_risk')->nullable();
            $table->string('desc_risk_other', 500)->nullable();
