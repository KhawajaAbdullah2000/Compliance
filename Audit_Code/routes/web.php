...
//for root users
Route::middleware(['auth', 'is_root_user', 'role:root admin'])->group(
    function () {
...
Route::middleware(['auth', 'is_user'])->group(
    function () {
...
Route::delete('/multistandard-risk-levels/{id}', 
    [IsoSec2_3_1::class, 'destroyMultistandardRiskLevel']
        ...
        route::post('proj_asset_selected_level_of_threat_qual_event/{proj_id}/{user_id}', [IsoSec2_3_1::class, 'proj_asset_selected_level_of_threat_qual_event']);
        ...
        route::get('ksa_nca_sec2_2_sub_req_edit/{sub_req}/{title}/{proj_id}/{user_id}/{asset_id}/{main_req?}/{readonly?}', [KSA_NCA::class, 'ksa_nca_sec2_2_sub_req_edit'])->name('ksa_nca_sec2_2_sub_req_edit');
        ...
        Route::get('compliance_map_sub_req/{domain}/{service}/{component}/{proj_id}/{title}', [ComplianceMap::class, 'compliance_map_sub_req'])->name('compliance_map_sub_req');
